...
The benchmark, the taxonomy, the scripts below and every file in \texttt{results/} are released at \url{https://github.com/phanibalagam/quest-qi} and archived at \url{https://doi.org/10.5281/zenodo.22668726}. That is the concept DOI, which always resolves to the latest archived version; the v1.0.0 release this manuscript describes is also citable on its own.
